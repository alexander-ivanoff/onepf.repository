 ...
 */
public class SqlPurchaseEntity extends SqlDBEntity<PurchaseDescriptor> implements GenericFields {
    ...
    public PurchaseDescriptor getDescriptor(ResultSet item) throws DataException {
        try {
